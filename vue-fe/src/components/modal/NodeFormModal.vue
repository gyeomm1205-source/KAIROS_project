          ...
          <div class="modal-body">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <select v-model="localForm.track" class="form-input form-select">
...
// [규칙 D] 수동 연결 시 시스템 트랙 포함 (필터 열기)
// 자동 연결(openCreateModal)은 같은 트랙만 허용하지만,
// 사용자가 직접 연결을 설정하는 경우에는 모든 트랙 허용
...
.modal-box {
  ...
  border-radius: 20px;
  /* CSS 변수로 테마별 분기 — App.vue .theme-dark / .theme-light 에서 내려옴 */
...
/* body.is-dark일 때 date/time picker UI도 어둡게 */
